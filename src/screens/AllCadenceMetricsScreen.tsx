...
type AllCadenceMetricsScreenProps = StackScreenProps<RootStackParamList, 'AllCadenceMetrics'>;

const { width: SCREEN_WIDTH } = Dimensions.get('window');

type TimeFrame = 'D' | 'W' | 'M' | 'Y';

export default function AllCadenceMetricsScreen({ navigation }: AllCadenceMetricsScreenProps) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Cadence Metrics</Text>
                <View style={{ width: 28 }} />
            </View>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                {renderChart('ACTIVE TIME', Math.round(avgActiveTime / 60).toString(), activeTimeData, MetricColors.speed, ' MIN')}
                {renderChart('TOTAL REPS', totalReps.toLocaleString(), repsData, MetricColors.sets)}
